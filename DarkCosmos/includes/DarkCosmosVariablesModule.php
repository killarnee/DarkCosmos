 ...
 */
class DarkCosmosVariablesModule extends ResourceLoaderSkinModule {
    /**
    ...
    protected function getLessVars( ResourceLoaderContext $context ) {
        ...
        // Backdrop image
        $backdrop = $config->get( 'DarkCosmosBackdropImage' );
    ...
    public function getDefinitionSummary( ResourceLoaderContext $context ) {
        ...
        $summary[] = [
            'DarkCosmosBackdropImage' => $this->getConfig()->get( 'DarkCosmosBackdropImage' )
        ];
        return $summary;
    }
}
